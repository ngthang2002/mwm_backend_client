...
namespace Project.App.Helpers
{
    public static class GeneralHelper
    {
        ...
        public static bool CheckDayInArray(this DateTime date, List<int> RepeaTvalues, bool isWeek)
        {
            if(isWeek)
            {
                return RepeaTvalues.Contains(((int)date.DayOfWeek));
            }
            else
            {
                return RepeaTvalues.Contains(((int)date.Day));
            }
        }
